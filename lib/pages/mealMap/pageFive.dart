...
class DinnerListScreen extends StatefulWidget {
  const DinnerListScreen({Key? key}) : super(key: key);

  @override
  _DinnerListScreenState createState() => _DinnerListScreenState();
}
...
class _DinnerListScreenState extends State<DinnerListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MainAppBar(appBar: AppBar(title: Text('Dinner List'))),
      body: Column(
        children: [
          Container(
