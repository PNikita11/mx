...
class TrackForm_M extends StatefulWidget {
  @override
  _TrackFormState createState() => _TrackFormState();
}

class _TrackFormState extends State<TrackForm_M> with SingleTickerProviderStateMixin {
  ...
  final List<int> numberValues = List.generate(14, (index) => 0);
...
bool check_empty(List<Map<String, dynamic>> images) {
  if (images.length != 4) {
    return false;
  }
  return true;
